...
import { CreateOrg } from "@/routes/dashboard/owner/kitchens/-components/OrgDialogs";
      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuSeparator />
            {isAdmin ? (
              <DropdownMenuItem onClick={() => setCreateOrgOpen(true)} className="gap-2 p-2">
                <div className="flex w-full justify-center gap-2">
                  <CreateOrg
                    trigger={
              ...
              <DropdownMenuItem onClick={() => navigate({ to: "/" })} className="gap-2 p-2">
