...
export function AdminUsersPage() {
  const search = useSearch({ from: "/dashboard/owner/users/" });
  const navigate = useNavigate({ from: "/dashboard/owner/" });
    ...
    return (
      <div className="mx-auto flex h-full w-full flex-col items-center justify-center p-6">
        <Empty>
          ...
          <EmptyContent>
            <Link to="/dashboard/owner/users/new" className="flex gap-2">
              <Button>
  ...
  return (
    <div className="flex h-full w-full min-w-[90%] flex-col gap-4">
      <div className="flex items-center justify-between gap-3">
        ...
        <Link to="/dashboard/owner/users/new" className="mt-3 md:mt-0">
          <Button>
            ...
            <div className="space-y-4 p-4">
              {paginatedUsers.map((u) => (
                <Card
                  ...
                  onClick={() =>
                    navigate({
                      to: `/dashboard/owner/users/$userid`,
                      params: { userid: u.id },
                    })
                  }
                >
              ...
              {query.isLoading ? (
                ...
                paginatedUsers.map((u) => (
                  <TableRow
                    ...
                    onClick={() =>
                      navigate({ to: `/dashboard/owner/users/$userid`, params: { userid: u.id } })
                    }
                  >
                    <TableCell>
