...
export function OrgList() {
  const search = useSearch({ from: "/dashboard/owner/kitchens/" });
  const navigate = useNavigate({ from: "/dashboard/owner/kitchens/" });
              ...
              {query.isLoading ? (
                ...
                paginatedOrgs.map((org) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <code className="bg-muted rounded px-2 py-1 text-xs">{org.slug}</code>
                    </TableCell>
