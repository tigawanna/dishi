        ...
        <Empty>
          ...
          <EmptyContent>
            <div className="flex gap-2">
              <Button
                variant="outline"
                onClick={() => navigate({ to: "/dashboard/owner/kitchens" })}
              >
                Back to List
              </Button>
    ...
    return (
      <div className="mx-auto flex h-full w-full flex-col items-center justify-center p-6">
        <Empty>
          ...
          <EmptyContent>
            <Button onClick={() => navigate({ to: "/dashboard/owner/kitchens" })}>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <p className="text-muted-foreground mb-1 text-sm font-medium">Slug</p>
            ...
            {org.logo && (
              <div>
                <p className="text-muted-foreground mb-1 text-sm font-medium">Logo</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <p className="text-muted-foreground mb-1 text-sm font-medium">Total Members</p>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                onClick={() =>
                  navigate({
                    to: `/dashboard/owner/kitchens/$orgId/members`,
                    params: { orgId: org.id },
                  })
                }
              >
