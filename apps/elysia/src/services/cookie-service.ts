 ...
 */
export function setCookie(context: any, name: string, value: string, options: CookieOptions = {}) {
 ...
 */
export function deleteCookie(context: any, name: string, options: CookieOptions = {}) {
